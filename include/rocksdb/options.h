...
// Options that control read operations on a single key
struct PointReadOptions {
  ...
  PointReadOptions() {}
  PointReadOptions(bool _verify_checksums, bool _fill_cache);
};

// Options that control general read operations
struct ReadOptions : public PointReadOptions {
