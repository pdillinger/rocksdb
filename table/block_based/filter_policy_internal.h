...
class BloomFilterPolicy : public FilterPolicy {
 ...
 private:
  ...
  // State for implementing optimize_filters_in_aggregate. Essentially, this
  // tracks a surplus or deficit in weighted average FP rate of filters
  // generated by builders under this policy vs. the target FP rate implied
  // by the bits_per_key setting.
  //
  // The actual value is the balance of
  //  sum over all generated filters f:
  //   (predicted_fp_rate(f) - target_fp_rate) * num_keys_added(f)
